...
public final class ServerVersionUtils {
    ...
    private static final ServerVersionUtils CURRENT = parse(Bukkit.getVersion());

    private final int major;
    private final int minor;
    private final int patch;

    private ServerVersionUtils(int major, int minor, int patch) {
        this.major = major;
        this.minor = minor;
        this.patch = patch;
    }
    ...
    private static ServerVersionUtils parse(String raw) {
        if (raw == null) {
            return new ServerVersionUtils(0, 0, 0);
        }
        ...
        return new ServerVersionUtils(major, minor, patch);
    }
